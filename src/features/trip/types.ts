...
export type Trip={id:string;code:string;name:string;baseCurrency:string;country?:string|null;startDate:string;endDate:string;plannerId:string;isFinalized:boolean;settings:TripSettings;version:number;canEditSettings:boolean;currencies?:string[]}
