...
export function ExpenseFilters({ participants, currencies }: { participants: Participant[]; currencies: string[] }) {
  ...
  return <div className="grid gap-2 rounded-xl border p-3 md:grid-cols-6">
