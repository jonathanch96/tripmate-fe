...
import type { MoneyAmount } from "@/features/finance/display-currency"
import type { LedgerEntry } from "@/features/finance/types"
import { formatMoney } from "@/lib/money"

const names = new Map([["u1", "Ana"], ["u2", "Ben"]])
const categoryName = () => "Food & Drink"
// The page passes in whichever currency the reader is viewing; the unit tests pin it to PHP.
const php = (amount: MoneyAmount) => formatMoney(amount, "PHP")
