...
export function FinalPage() {
  ...
  return <section className="space-y-6"><div className="flex items-end justify-between"><div><h1 className="font-heading text-[26px] font-extrabold">Final plan</h1><p className="mt-1.5 text-sm text-muted-foreground">Lock rates and finish with the smallest practical transfer plan.</p></div>{trip.isFinalized ? <Badge>Finalized</Badge> : null}</div>
