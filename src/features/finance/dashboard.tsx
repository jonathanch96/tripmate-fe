...
export function Dashboard() {
  ...
  return <section className="space-y-8">
    ...
    {result.summary.expenseCount === 0 ? <div className="rounded-2xl border border-dashed px-6 py-11 text-center"><p className="font-bold">No activity yet</p><p className="mb-5 mt-1 text-sm text-muted-foreground">Add your first expense to see it show up here.</p><div className="flex justify-center"><ExpenseDialog trip={trip} participants={participants} pending={create.isPending} onSubmit={(payload) => create.mutate(payload)} onReceiptConverted={refresh} /></div></div> : <>
